...
folder = "test/"
faces_folder = folder#sys.argv[1]
...
training_xml_path = os.path.join(faces_folder, "traincoins.xml")
testing_xml_path = os.path.join(faces_folder, "testcoins.xml")
...
# results.
test_fold = os.path.join(faces_folder, "tmp/TestingLab/" )
